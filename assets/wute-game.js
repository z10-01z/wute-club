...
(function () {
    ...
    var STYLE = [
        ...
        '#wuteGame .g-title b { color: #7db4ff; }',
        ...
        '  color: #7db4ff; letter-spacing: 0.35em; text-transform: uppercase; margin-bottom: 10px; }',
        '#wuteGame .g-h1 { color: #fff; font-size: 30px; font-weight: 800; letter-spacing: 0.12em; margin-bottom: 6px; }',
        '#wuteGame .g-h1 b { color: #7db4ff; }',
        ...
        '#wuteGame .g-score { color: #9aa0ab; font-size: 12px; letter-spacing: 0.15em; margin-bottom: 20px; }',
        ...
        '#wuteGame .g-note { color: #9aa0ab; font-size: 11px; letter-spacing: 0.1em; margin-top: 20px; line-height: 1.8; }',
        '#wuteGame .g-note b { color: #888894; }',
        '#wuteGame .g-record { color: #ff7379; font-size: 13px; font-weight: 700; letter-spacing: 0.15em;',
        '  margin-bottom: 18px; animation: wuteGameBlink 1s steps(2) infinite; }',
        '@keyframes wuteGameBlink { 50% { opacity: 0.3; } }',
        '@media (prefers-reduced-motion: reduce) { #wuteGame .g-record { animation: none; } }',
        '#wuteGame .g-hint { position: absolute; bottom: 14px; left: 0; right: 0; text-align: center;',
        '  color: #9aa0ab; font-size: 11px; letter-spacing: 0.12em; }',
